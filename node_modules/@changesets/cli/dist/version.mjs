...
async function version(options) {
	...
	if (options.ignore != null) {
		if (config.ignore.length > 0) messages.push("It looks like you are trying to use the `--ignore` option while ignore is defined in the config file. This is currently not allowed, you can only use one of them at a time.");
